...
public class ClienteRepository implements repository.IRepository<Cliente> {

    @Override
    public List<Cliente> findAll() throws SQLException, ClassNotFoundException {
        Connection conn = ConnectionManager.getConnection();
        PreparedStatement statement = conn.prepareStatement("SELECT * FROM folha_owner.clientes ");
    ...
    public Cliente findById(Integer id) throws SQLException, ClassNotFoundException {
        Connection conn = ConnectionManager.getConnection();
        PreparedStatement statement3 = conn.prepareStatement("SELECT * FROM folha_owner.clientes WHERE id = ?");
